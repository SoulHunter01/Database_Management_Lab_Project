<html>
	...
	<body>
		<div class="wrapper">
			...
			<?php
				function sellItems($con, $query) {
					$query_id = oci_parse($con, $query);
					$r = oci_execute($query_id);

					if ($r) {
						oci_commit($con);
						echo "<label>Items sold Successfully into the Database.</label>";
					} else {
						oci_rollback($con);
						$error = oci_error($query_id);
						echo "<label>Items not successfully sold due to this error: ".$error['message']."</label>";
					}
				}
